        ...
        <View style={styles.screen1}>
            <View style={styles.header}>
                ...
                <View style={styles.item1}>
                    <Text style={styles.headText}>Ihza</Text>
                </View>

                <View style={[styles.item1, { marginLeft: Screen.width * 0.01 }]}>
                    <Text style={styles.headText}>085271773322</Text>
                </View>

                <View style={[styles.item2, { marginLeft: Screen.width * 0.01 }]}>
                    <Text style={styles.headText}>Ihza@gmail.com</Text>
                </View>

                <View style={[styles.item3, { marginLeft: Screen.width * 0.01 }]}>
                    <Text style={styles.headText}>Dewantara, UleePulo</Text>
                </View>
