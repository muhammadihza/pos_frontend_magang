        ...
        <View style={styles.screen1}>
            <View style={styles.header}>
                ...
                <View style={styles.item1}>
                    <Text style={styles.headText}>Irwan</Text>
                </View>

                <View style={[styles.item1, { marginLeft: Screen.width * 0.01 }]}>
                    <Text style={styles.headText}>085275313322</Text>
                </View>

                <View style={[styles.item2, { marginLeft: Screen.width * 0.01 }]}>
                    <Text style={styles.headText}>Irwan@gmail.com</Text>
                </View>
